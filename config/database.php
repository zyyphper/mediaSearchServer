    ...
    */
    ...
    'connections' => [
        ...
        'org' => [
            ...
            'host' => env('ORG_DB_HOST', '127.0.0.1'),
            'port' => env('ORG_DB_PORT', '3306'),
            'database' => env('ORG_DB_DATABASE', 'forge'),
            'username' => env('ORG_DB_USERNAME', 'forge'),
            'password' => env('ORG_DB_PASSWORD', ''),
            'unix_socket' => env('ORG_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
        ...
        'business' => [
            ...
            'host' => env('BUSINESS_DB_HOST', '127.0.0.1'),
            'port' => env('BUSINESS_DB_PORT', '3306'),
            'database' => env('BUSINESS_DB_DATABASE', 'forge'),
            'username' => env('BUSINESS_DB_USERNAME', 'forge'),
            'password' => env('BUSINESS_DB_PASSWORD', ''),
        ...
        'member' => [
            ...
            'unix_socket' => env('MEMBER_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
